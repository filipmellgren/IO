...
To determine the fixed costs F, we include the following variables in the (fixed) cost shifters vector W: average price per square-meter of houses sold (hprice), the number of houses sold (hsold) and the average monthly wage (wage). We include the average price per square-meter of houses sold as it functions as a proxy that captures the cost of buying the facility. 
The number of houses sold captures the search cost of finding a suitable facility. The average monthly wage captures the fixed costs associated with staffing the stores. 
