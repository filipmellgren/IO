...
Figure_data <- df %>% gather(key = "Specification", value = "value", e_jj_nl, e_jj_nl_fe) %>%group_by(firm, Specification) %>% summarise("mean_el" = abs(mean(value)), "se" = sd(value)/sqrt(n()))
